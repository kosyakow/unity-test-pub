...
xcodebuild -exportArchive -exportFormat ipa -archivePath "./unity-test/VungleUnityTest.xcarchive/" -exportPath "./unity-test/VungleUnityTest.ipa" -exportProvisioningProfile "iOSTeam Provisioning Progile: *"
