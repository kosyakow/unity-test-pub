...
#"c:/Program Files/Unity/Editor/Unity" -quit -batchmode -nographics -projectPath $PROJECT_PATH/unity-test -executeMethod BuildGenerator.BuildWin81 -CustomArgs:ver=$version.$build.$rev
...
"$NUGET" restore unity-test/Builds/WSA/VungleUnity5Test_win81.sln

echo "Building UWP test"
"$MS_BUILD_EXE" "/p:Configuration=Release;Platform=x86;AppxBundle=Always;AppxBundlePlatforms=x86|ARM" unity-test/Builds/WSA/VungleUnity5Test_win81/VungleUnity5Test_win81.csproj

echo "Create test zip"
PACKAGES="unity-test/Builds/WSA/VungleUnity5Test_win81/AppPackages/VungleUnity5Test_win81_*_Test"
