...
"$NUGET" restore unity-test/Builds/WSA/VungleUnityTest_wp81.sln

sed -i -- 's/Publisher=\"CN=Vungle\"/Publisher=\"OID.0.9.2342.19200300.100.1.1=11249643, CN=Vungle, OU=Vungle\"/g' unity-test/Builds/WSA/VungleUnityTest_wp81/Package.appxmanifest

echo "Building test"
"$MS_BUILD_EXE" "/p:Configuration=Release;Platform=ARM" unity-test/Builds/WSA/VungleUnityTest_wp81/VungleUnityTest_wp81.csproj
echo "Sign"
